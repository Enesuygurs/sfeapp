...
def ayarlari_yukle():
    ...
    if not os.path.exists(CONFIG_DOSYASI):
        ...
        config['Arayuz'] = {'font_boyutu': '20', 'font_rengi': 'white', 'arka_plan_rengi': 'black', 'seffaflik': '0.7', 'ekran_ust_bosluk': '30', 'kontrol_araligi': '0.4', 'ceviri_omru': '3.0', 'kaynak_metin_benzerlik_esigi': '0.9'}
        config['Kisayollar'] = {'alan_sec': 'f8', 'durdur_devam_et': 'f9', 'programi_kapat': 'f10','kaynak_metin_min_uzunluk': '3'}
        with open(CONFIG_DOSYASI, 'w', encoding='utf-8') as configfile: config.write(configfile)
